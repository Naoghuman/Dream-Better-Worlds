...
public class ExtendedSliderWidgetPresenter implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        LoggerFacade.INSTANCE.info(this.getClass(), "Initialize ExtendedSliderWidgetPresenter"); // NOI18N
    ...
    public void onActionEdit() {
        LoggerFacade.INSTANCE.info(this.getClass(), "On action edit"); // NOI18N
    ...
    public void onActionReadMore() {
        LoggerFacade.INSTANCE.info(this.getClass(), "On action read more"); // NOI18N
