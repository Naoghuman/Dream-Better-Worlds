...
public class ParentElementPresenter implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        LoggerFacade.INSTANCE.trace(this.getClass(), "Initialize ParentElementPresenter");
    ...
    public void configure(Long generationTime, String date) {
        LoggerFacade.INSTANCE.trace(this.getClass(), "Configure ParentElementPresenter"); // NOI18N
