 ...
 * @author PRo
 */
public class SaveMultiFilesDialogPresenter implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        LoggerFacade.getDefault().info(this.getClass(), "Initialize SaveMultiFilesPresenter"); // NOI18N
