...
public class VotingComponentPresenter implements Initializable, IActionConfiguration {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        LoggerFacade.INSTANCE.info(this.getClass(), "Initialize VotingComponentPresenter");
    ...
    public void configure(VotingComponentModel votingComponentModel) {
        LoggerFacade.INSTANCE.info(this.getClass(), "Configure VotingComponentPresenter"); // NOI18N
