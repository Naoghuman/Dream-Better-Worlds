 ...
 * @author PRo
 */
public class DreamFileSqlProvider {
    
    private static DreamFileSqlProvider instance = null;
    
    public static DreamFileSqlProvider getDefault() {
        if (instance == null) {
            instance = new DreamFileSqlProvider();
        }
        
        return instance;
    }
    
    private DreamFileSqlProvider() {}
