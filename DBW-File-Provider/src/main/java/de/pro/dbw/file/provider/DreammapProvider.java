...
//    }
    ...
    public void register(TabPane tpEditor) {
        LoggerFacade.INSTANCE.getLogger().info(this.getClass(), "Register TabPane editor in DreammapProvider");
    ...
    public void registerActions() {
        LoggerFacade.INSTANCE.getLogger().debug(this.getClass(), "Register actions in DreammapProvider");
