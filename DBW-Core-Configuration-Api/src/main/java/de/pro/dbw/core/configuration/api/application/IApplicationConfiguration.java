...
public interface IApplicationConfiguration {
    ...
    public static final String DBW__TITLE__APPLICATION = "Dream Better Worlds v0.1.1-SNAPSHOT"; // NOI18N -SNAPSHOT
    public static final String DBW__TITLE__TESTDATA = "Testdata v0.1.1-SNAPSHOT"; // NOI18N -SNAPSHOT
