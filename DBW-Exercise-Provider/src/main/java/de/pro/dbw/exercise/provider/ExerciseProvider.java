...
public class ExerciseProvider implements IActionConfiguration, IRegisterActions {
    ...
    public void register(TabPane tpEditor) {
        LoggerFacade.INSTANCE.info(this.getClass(), "Register TabPane editor in ExerciseProvider"); // NOI18N
    ...
    public void registerActions() {
        LoggerFacade.INSTANCE.debug(this.getClass(), "Register actions in ExerciseProvider"); // NOI18N
