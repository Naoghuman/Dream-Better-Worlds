...
import de.pro.dbw.application.testdata.api.TestdataFacade;
...
public class TestdataApplication extends Application implements ITestdataConfiguration {
    ...
    public void start(Stage primaryStage) throws Exception {
        final Scene scene = new Scene(TestdataFacade.INSTANCE.getView(), 1280.0d, 720.0d);
    ...
    private void onCloseRequest() {
        ...
        try {
            TestdataFacade.INSTANCE.shutdown();
