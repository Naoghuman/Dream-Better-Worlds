 ...
 */
package de.pro.dbw.base.component.api.listview.checkbox;
...
public class CheckBoxListCell<T> extends ListCell<T> {
    ...
    public static <T> Callback<ListView<T>, ListCell<T>> forListView(
        ...
        return list -> new CheckBoxListCell<>(getSelectedProperty, disableProperty, 
                CellUtils.<T>defaultStringConverter());
    }
