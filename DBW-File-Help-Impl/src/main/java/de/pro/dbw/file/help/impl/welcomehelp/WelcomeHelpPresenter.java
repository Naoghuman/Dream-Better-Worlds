...
//    @FXML private TextArea taWhatToShow = null;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        LoggerFacade.getDefault().info(this.getClass(), "Initialize WelcomeHelpFilePresenter"); // NOI18N
...
//        assert (taWhatToShow != null)  : "fx:id=\"taWhatToShow\" was not injected: check your FXML file 'WelcomeFile.fxml'."; // NOI18N
    ...
    private void initializeShowAtStart() {
        final Boolean selected = PreferencesFacade.getDefault().getBoolean(
    ...
    public void showAtStart() {
        LoggerFacade.getDefault().debug(this.getClass(), "Show at start: " + cbShowAtStart.isSelected());
