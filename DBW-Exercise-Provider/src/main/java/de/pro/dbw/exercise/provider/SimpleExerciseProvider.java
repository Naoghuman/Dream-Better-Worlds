...
public class SimpleExerciseProvider implements IActionConfiguration, IRegisterActions {
    ...
    public void register(TabPane tpEditor) {
        LoggerFacade.INSTANCE.getLogger().info(this.getClass(), "Register TabPane editor in SimpleExerciseProvider"); // NOI18N
    ...
    public void registerActions() {
        LoggerFacade.INSTANCE.getLogger().debug(this.getClass(), "Register actions in SimpleExerciseProvider"); // NOI18N
