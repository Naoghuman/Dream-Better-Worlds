...
* Update the parameter `title` in the files `DreamBetterWorlds.properties`, 
  `PerformanceApplication.properties` and `TestdataApplication.properties` from 
  the child-modul `DBW-Application`.
