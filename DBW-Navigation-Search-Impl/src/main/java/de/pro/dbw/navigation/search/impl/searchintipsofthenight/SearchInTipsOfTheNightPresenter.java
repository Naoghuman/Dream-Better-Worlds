...
public class SearchInTipsOfTheNightPresenter implements Initializable, IActionConfiguration {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        LoggerFacade.INSTANCE.getLogger().info(this.getClass(), "Initialize SearchInTipsOfTheNightPresenter"); // NOI18N
    ...
    public void onActionSearchInTipsOfTheNight() {
        LoggerFacade.INSTANCE.getLogger().debug(this.getClass(), "On action search in Tip of the Nights"); // NOI18N
